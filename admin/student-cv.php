...
<h1 style="text-align: center;">Student-Jobs</h1>
...
<table class="table table-bordered"  id="myTable">
  ...
  <tr>
    ...
    <td class="col-md-1"><img src="<?php echo '/' .   str_replace("../", "", $row["user_img"]); ?>" alt="Responsive image" class="img-responsive"></td>
    <td style="text-align:center">
      <a href="insert/delete-cv.php? user_id=<?php echo $row["user_id"]; ?>">
