...
if($uploadOk == 1){
	...
	$query = "INSERT INTO `user` (`user_id`, `user_name`,`user_ban`, `user_work`, `user_study`,`user_facebook`,`user_email`,`user_phone`,`user_text`,`user_love`,`user_money`,`user_img`) VALUES (NULL, '" . $user_name ."', '$user_ban', '$user_work','$user_study','$user_facebook','$user_email','$user_phone','$user_text','$user_love','$user_money','$target_file')";
